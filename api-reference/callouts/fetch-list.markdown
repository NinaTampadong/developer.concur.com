...
* The third-party developer or client can configure and maintain the public web service interface (the application connector). This guide specifies the request and response format required by Concur.
